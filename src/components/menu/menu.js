...
const LanguageDropdownMobile = ({ 
    ...
    return (
        <li className='nav-menu-item-mob py-3'>
            <p className="fs-2 text-uppercase m-0 d-flex align-items-center justify-content-between"
            onClick={() => {setShowMobileMenu(false); setShowLanguageMob(true)}}>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#fcfcfc">
...
export const Menu = () => {
    ...
    const mouseEventSolutions = (isShow) => {
        closeAllTabs();
    ...
    const closeAllTabs = () =>{
        ...
        setShowLocationsMob(false);
        setShowLanguageMob(false);
    }
  ...
  return (
    <>
        ...
        <div className="syd-header sticky-top">
            <nav id="main-nav" className="navbar sticky-top d-block p-0 navbar-bg d-none d-lg-flex align-items-center justify-content-between transition-03s-eio">
            {
                ...
                <ul id="syd-menu" className='d-flex p-4 align-items-center'>
                    <li>
                    ...
                    {/* {
                        ...
                        <li>
                            <NavLink to={`/${lang}/services`} className={({ isActive }) => `${isActive ? "is-active-navlink " : ""}d-flex gap-1 fw-bold main-nav-link`} onMouseEnter={()=>mouseEventServices(true)} onClick={() => mouseEventServices(false)}>
                    ...
                    } */}
                    {
                        TranslationsService.sectionAvailable('services') &&
                        <li>
                            <NavLink to={`/${lang}/services`} className={({ isActive }) => `${isActive ? "is-active-navlink " : ""}d-flex gap-1 fw-bold main-nav-link`}   onClick={(e) => {e.preventDefault(); toggleMenu("services");}}>
                            {/* <NavLink to={`/${lang}/services`} className={({ isActive }) => `${isActive ? "is-active-navlink " : ""}d-flex gap-1 fw-bold main-nav-link`}   onClick={(e) => {e.preventDefault(); mouseEventServices(showServices);}}> */}
                                {TranslationsService.labels(`menu.services.label`)}
                                <svg id="Livello_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 29.96 17.12" className={`arrow-icon-nav ${showServices ? 'rotated':''} transition-03s-eio`}><path d="m29.96,2.14c0,.55-.21,1.09-.63,1.51l-12.84,12.84c-.4.4-.94.63-1.51.63s-1.11-.22-1.51-.63L.63,3.65C-.21,2.82-.21,1.47.63.63,1.47-.21,2.82-.21,3.65.63l11.32,11.32L26.3.63c.84-.84,2.19-.84,3.03,0,.42.42.63.96.63,1.51Z"/></svg>
                            </NavLink>
                        </li>
                    ...
                    {/* {
                        TranslationsService.sectionAvailable('services') && */}
                        <li>
                            <NavLink to={`/${lang}/solutions`} className={({ isActive }) => `${isActive ? "is-active-navlink " : ""}d-flex gap-1 fw-bold main-nav-link`}   onClick={(e) => {e.preventDefault(); toggleMenu("solutions");}}>
                                {TranslationsService.labels(`menu.solutions.label`)}
                                <svg id="Livello_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 29.96 17.12" className={`arrow-icon-nav ${showServices ? 'rotated':''} transition-03s-eio`}><path d="m29.96,2.14c0,.55-.21,1.09-.63,1.51l-12.84,12.84c-.4.4-.94.63-1.51.63s-1.11-.22-1.51-.63L.63,3.65C-.21,2.82-.21,1.47.63.63,1.47-.21,2.82-.21,3.65.63l11.32,11.32L26.3.63c.84-.84,2.19-.84,3.03,0,.42.42.63.96.63,1.51Z"/></svg>
                            </NavLink>
                        </li>
                    {/* } */}

                    {
                        ...
                        <li>
                            <NavLink to={`/${lang}/products`} className={({ isActive }) => `${isActive ? "is-active-navlink " : ""}d-flex gap-1 fw-bold main-nav-link`} onClick={(e) => {e.preventDefault(); toggleMenu("products");}}>
                            {/* <NavLink to={`/${lang}/services`} className={({ isActive }) => `${isActive ? "is-active-navlink " : ""}d-flex gap-1 fw-bold main-nav-link`}   onClick={(e) => {e.preventDefault(); mouseEventServices(showServices);}}> */}
                        ...
                        // <li>
                        //     <NavLink to={`/${lang}/products`}  className={({ isActive }) => `${isActive ? "is-active-navlink " : ""}d-flex gap-1 fw-bold main-nav-link`} onMouseEnter={()=>mouseEventProducts(true)} onClick={() => mouseEventProducts(false)}>
                        //         {TranslationsService.labels(`menu.products.label`)}
                    ...
                    }
                    {
                        ...
                        <li>
                            <NavLink to={`/${lang}/industries`}  className={({ isActive }) => `${isActive ? "is-active-navlink " : ""}d-flex gap-1 fw-bold main-nav-link`} onMouseEnter={()=>mouseEventIndustries(true)} onClick={() => mouseEventIndustries(false)}>
                    ...
                    }
                    {
                        ...
                        <li>
                            <NavLink to={`/${lang}/insights`} className={({ isActive }) => `${isActive ? "is-active-navlink " : ""}d-flex gap-1 fw-bold main-nav-link`}   onClick={(e) => {e.preventDefault(); toggleMenu("insights");}}>
                                Insights
                                <svg id="Livello_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 29.96 17.12" className={`arrow-icon-nav ${showServices ? 'rotated':''} transition-03s-eio`}><path d="m29.96,2.14c0,.55-.21,1.09-.63,1.51l-12.84,12.84c-.4.4-.94.63-1.51.63s-1.11-.22-1.51-.63L.63,3.65C-.21,2.82-.21,1.47.63.63,1.47-.21,2.82-.21,3.65.63l11.32,11.32L26.3.63c.84-.84,2.19-.84,3.03,0,.42.42.63.96.63,1.51Z"/></svg>
                            </NavLink>
                        </li>
                    }
                    {
                        ...
                        <li>
                            <NavLink to={`/${lang}/about`} className={({ isActive }) => `${isActive ? "is-active-navlink " : ""}d-flex gap-1 fw-bold main-nav-link`}   onClick={(e) => {e.preventDefault(); toggleMenu("about");}}>
                    ...
                    }
                    {
                        ...
                        <li>
                            <NavLink to={`/${lang}/careers`} className={({ isActive }) => `${isActive ? "is-active-navlink " : ""} fw-bold main-nav-link`} onMouseEnter={()=>mouseEventCareers(true)} onClick={() => mouseEventCareers(false)}>{TranslationsService.labels(`menu.careers.label`)}</NavLink>
                    ...
                    }
                    {
                        appOwner === 'sydea' && isAuthenticated &&
                        <li>
                            <NavLink to={`/${lang}/sydea-hub`} className='fw-bold main-nav-link'>Sydea Hub</NavLink>
                        </li>
                    }
                </ul>
                <div className="d-flex gap-2 align-items-center p-4">
                    {
                        ...
                        <button className="syd-button fw-bold" onClick={() => navigate(`/${lang}/contacts`)} style={{textTransform:'inherit', borderRadius:0}}>
            ...
            {/* {
                showServices &&
                <MegaMenu section='service'/>
            } */}
            <MegaMenu
                show={openMenu === "services"}
                menu="services"
                lang={lang}
            ...
            <MegaMenu
                ...
                onClose={closeAllTabs}
            />
            {/* <div className={`syd-mega-menu ${showServices ? 'show':''}`}>
                <div className="container">
                    <div className="d-flex justify-content-between align-items-center">    
                        <div>
                            <NavLink to={`/${lang}/services`} className='d-flex gap-1 fw-bold title-mega-menu' onClick={() => mouseEventServices(false)}>
                                <h2 className="fw-bold m-0 p-0 lh-1 d-flex align-items-center gap-2">
                                    {TranslationsService.labels(`menu.services.label`)}
                                    <ArrowForwardIcon style={{fontSize: '2rem'}} className="icon-title-mega-menu"/>
                                </h2>
                            </NavLink>
                        </div>                
                        <IconButton aria-label="delete" className="close-btn-mega-menu" onClick={closeAllTabs}>
        ...
        <nav id="main-nav-mob" className="navbar sticky-top d-block d-flex d-lg-none align-items-center p-0">
            <div className="box-header-mobile-menu p-4" style={{zIndex: 9991}}>
                ...
                {/* <IconButton className="hamburger-menu" onClick={openMobileMenu} sx={{ color: "#fcfcfc" }}>
                    <MenuIcon />
                </IconButton> */}
                <IconButton
                    ...
                    sx={{ color: "#fcfcfc" }}
                >
                    {menuMobileOpen ? <CloseIcon /> : <MenuIcon />}
                </IconButton>
            <Link to={`/${lang}`} className="m-auto logo-mobile-header" onClick={closeMobileMenu}>
                {
                    appOwner === 'sydea' &&
            ...
            <div className="offcanvas offcanvas-start" tabIndex="-1" id="offcanvasMenu" aria-labelledby="offcanvasMenu">
                <div className="offcanvas-header p-4">
                    ...
                    {/* <IconButton
                        ...
                        id="btn-close-off-mobile"
                        sx={{ color: "#fcfcfc" }}
                    >
                        <CloseIcon />
                    </IconButton> */}
                    {/* <button type="button" className="btn-close" data-bs-dismiss="offcanvas" aria-label="Close" id="btn-close-off-mobile" style={{color:'#fcfcfc'}}></button> */}
                ...
                <div className="offcanvas-body position-relative">
                    {
                        ...
                        <>
                            <div>
                                ...
                                {
                                    TranslationsService.sectionAvailable('services') &&
                                    <li className={`nav-menu-item-mob py-3`} onClick={() => mouseEventServices(true)}>
                                        <p className="fs-4 fw-bold m-0 d-flex align-items-center justify-content-between">
                                            <span>{TranslationsService.labels(`menu.services.label`)}</span>
                                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#fcfcfc"><path d="m1,14c-.26,0-.51-.1-.71-.29-.39-.39-.39-1.02,0-1.41l5.29-5.29L.29,1.71C-.1,1.32-.1.68.29.29.68-.1,1.32-.1,1.71.29l6,6c.19.19.29.44.29.71s-.11.52-.29.71L1.71,13.71c-.2.2-.45.29-.71.29Z"/></svg>
                                        </p>
                                    </li>
                                }
                                {/* {
                                    TranslationsService.sectionAvailable('services') && */}
                                    <li className={`nav-menu-item-mob py-3`} onClick={() => mouseEventSolutions(true)}>
                                        <p className="fs-4 fw-bold m-0 d-flex align-items-center justify-content-between">
                                            <span>{TranslationsService.labels(`menu.solutions.label`)}</span>
                                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#fcfcfc"><path d="m1,14c-.26,0-.51-.1-.71-.29-.39-.39-.39-1.02,0-1.41l5.29-5.29L.29,1.71C-.1,1.32-.1.68.29.29.68-.1,1.32-.1,1.71.29l6,6c.19.19.29.44.29.71s-.11.52-.29.71L1.71,13.71c-.2.2-.45.29-.71.29Z"/></svg>
                                        </p>
                                    </li>
                                {/* } */}
                                {
                                    TranslationsService.sectionAvailable('products') &&
                                    <li className={`nav-menu-item-mob py-3`} onClick={() => mouseEventProducts(true)}>
                                        <p className="fs-4 fw-bold m-0 d-flex align-items-center justify-content-between">
                                ...
                                {
                                    TranslationsService.sectionAvailable('industries') &&
                                    <li className={`nav-menu-item-mob py-3`} onClick={() => mouseEventIndustries(true)}>
                                        <p className="fs-4 fw-bold m-0 d-flex align-items-center justify-content-between">
                                ...
                                {
                                    TranslationsService.sectionAvailable('insights') &&
                                    <li className={`nav-menu-item-mob py-3`} onClick={() => mouseEventInsights(true)}>
                                        <p className="fs-4 fw-bold m-0 d-flex align-items-center justify-content-between">
                                            <span>Insights</span>
                                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#fcfcfc"><path d="m1,14c-.26,0-.51-.1-.71-.29-.39-.39-.39-1.02,0-1.41l5.29-5.29L.29,1.71C-.1,1.32-.1.68.29.29.68-.1,1.32-.1,1.71.29l6,6c.19.19.29.44.29.71s-.11.52-.29.71L1.71,13.71c-.2.2-.45.29-.71.29Z"/></svg>
                                        </p>
                                    ...
                                    {/* <li className={`nav-menu-item-mob py-3`} onClick={closeMobileMenu}>
                                ...
                                {
                                    TranslationsService.sectionAvailable('about') &&
                                    <li className={`nav-menu-item-mob py-3`} onClick={() => mouseEventAbout(true)}>
                                        <p className="fs-4 fw-bold m-0 d-flex align-items-center justify-content-between">
                            ...
                            <div>
                                <ul id="syd-menu">
                                    <li className='nav-menu-item-mob py-3' onClick={() => {setShowMobileMenu(false); setShowLocationsMob(true);}}>
                                        <p className="fs-4 fw-bold m-0 d-flex align-items-center justify-content-between">
                                            <span>{TranslationsService.labels('locations')}</span>
                                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#fcfcfc"><path d="m1,14c-.26,0-.51-.1-.71-.29-.39-.39-.39-1.02,0-1.41l5.29-5.29L.29,1.71C-.1,1.32-.1.68.29.29.68-.1,1.32-.1,1.71.29l6,6c.19.19.29.44.29.71s-.11.52-.29.71L1.71,13.71c-.2.2-.45.29-.71.29Z"/></svg>
                                        </p>
                                    </li>
                                    {/* <li className='nav-menu-item-mob py-3' onClick={() => setShowLanguageMob(true)}>
                                        <p className="fs-2 text-uppercase m-0 d-flex align-items-center justify-content-between">
                                            <span className="d-flex gap-3">
...

                                {
                                    ...
                                    <>
                                        <br/>
                                        <br/>
                                        <p className="fs-4 fw-bold m-0 d-flex align-items-center gap-1" onClick={signIn}>
                                            <LockOutlinedIcon /> <span>Restricted Area</span>
                                        </p>
                                    </>
                                }
                                ...
                                {appOwner === 'sydea' && isAuthenticated && (
                                    <div>
                                        <p className="mb-0 mt-3 fw-bold" style={{background:'#272727', width: 'max-content', color:'#fece2f', padding: '0.3rem 0.5rem'}}>Restricted Area</p>
                                        <div style={{background: '#272727'}} className="p-3">
                                            <div className="d-flex align-items-center pb-3">
                                            {
                                                activeAccount && 
                                                <div className="w-75">
                                                    <p className='m-0' style={{wordBreak: 'break-all'}}>{activeAccount.username}</p>
                                                </div>
                                            }
                                            {
                                                activeAccount && 
                                                <div className="w-25 d-flex justify-content-end">
                                                    {/* import PowerSettingsNewIcon from '@mui/icons-material/PowerSettingsNew';
                                                    import LogoutIcon from '@mui/icons-material/Logout'; */}
                                                    <IconButton style={{backgroundColor: '#141414'}} size="large" onClick={signOut}>
                                                        <LogoutIcon style={{color: '#f7f7f7'}} fontSize="inherit"/>
                                                    </IconButton>
                                            ...
                                            <li style={{backgroundColor:'#fece2f', width:'max-content', padding:'0.3rem 1rem'}} onClick={closeMobileMenu}>
                                                <NavLink to={`/${lang}/sydea-hub`} className='fs-5 m-0 d-flex align-items-center gap-2 nav-menu-item-mob py-1 fw-bold'>
                                                    <HubOutlinedIcon sx={{fontSize: '18px'}}/>
                                                    <span>Sydea Hub</span>
                                ...
                                <img src={appOwner === 'sydea' ? SydeaLogoLight : IndastriaLogoDark} alt='Sydea logo' className='logo-mob-nav-b'></img>
                    ...
                    {
                        TranslationsService.sectionAvailable('services') &&
                        <div className={`container sub-nav-mob ${showServices ? 'show-services-menu':''}`}>
                            <div className="d-flex p-3" onClick={() => mouseEventServices(false)}>
                                <svg id="Livello_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 11.43 20" width="10" fill="#fcfcfc"><path d="m10,20c-.37,0-.73-.14-1.01-.42L.42,11.01c-.27-.27-.42-.63-.42-1.01s.15-.74.42-1.01L8.99.42c.56-.56,1.46-.56,2.02,0s.56,1.46,0,2.02l-7.56,7.56,7.56,7.56c.56.56.56,1.46,0,2.02-.28.28-.64.42-1.01.42Z"/></svg>
                                        ...
                                        <div>
                                            <ul style={{padding:0}}>
                                            {
                                                ...
                                                Object.keys(TranslationsService.labels('services')[area].items).map((_sub, i) => (
                                                    <ul key={i} className="p-0 m-0 submenu-items-mobile">
                                                        <b className="text-capitalize fs-4">{TranslationsService.labels('services')[area].items[_sub].title}</b>
                                                    {
                                                        ...
                                                        Object.keys(TranslationsService.labels('services')[area].items[_sub]).map((_subItem, j) => (
                                                            ...
                                                            (
                                                            <li key={j} className="ms-2 mb-2 row-submenu-mobile">
                                                                <Link to={`/${lang}/services/${area}/${_sub}/${_subItem}`} className="text-capitalize fs-6 link-mobile-menu" onClick={() => { mouseEventServices(false); closeMobileMenu() }}>
                                                                    {TranslationsService.labels('services')[area].items[_sub][_subItem].title}
                                                ...
                                                (
                                                    <li key={indice} className="pb-4">
                                                        {/* <Link to={`services/${area}`} className="text-capitalize fw-bold fs-3" onClick={() => { mouseEventServices(false); closeMobileMenu() }}>
                                                            {TranslationsService.labels('services')[area].title}
                                                        </Link> */}
                                                        <ul className="p-0 m-0">
                                                            {Object.entries(TranslationsService.labels('services')[area])
                                                                .filter(([key, value]) => typeof value === "object" && value?.title)
                                                                .map(([sub, value], i) => (
                                                                <li key={i} className="ms-2 mb-2 row-submenu-mobile">
                                                                    <Link
                                                                        to={`/${lang}/services/${area}/${sub}`}
                                                                        className="text-capitalize fs-6 link-mobile-menu"
                                                                        onClick={() => { mouseEventServices(false); closeMobileMenu() }}
                                                                    >
                                                                        {value.title}
                                                                        <ArrowForwardIosIcon sx={{ fontSize: '16px' }} />
                                                                    </Link>
                                    ...
                                    <li key={indice} className="pb-4">
                                        ...
                                        <ul>
                                            {Object.keys(TranslationsService.labels('services')[area]).map((_sub, i) => (
                                                <li key={i}>
                                                    <Link to={`services/${area}/${_sub}`} className="text-capitalize fs-6" onClick={() => { mouseEventServices(false); closeMobileMenu() }}>
                    ...
                    {/* {
                        TranslationsService.sectionAvailable('products') && */}
                        <div className={`container sub-nav-mob ${showSolutions ? 'show-solutions-menu':''}`}>
                            <div className="d-flex p-3" onClick={() => mouseEventSolutions(false)}>
                                <svg id="Livello_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 11.43 20" width="10" fill="#fcfcfc"><path d="m10,20c-.37,0-.73-.14-1.01-.42L.42,11.01c-.27-.27-.42-.63-.42-1.01s.15-.74.42-1.01L8.99.42c.56-.56,1.46-.56,2.02,0s.56,1.46,0,2.02l-7.56,7.56,7.56,7.56c.56.56.56,1.46,0,2.02-.28.28-.64.42-1.01.42Z"/></svg>
                                <p className="m-0 fw-bold ms-2 fs-3">{TranslationsService.labels(`menu.solutions.label`)}</p>
                            </div>
                            <ul>
                                {
                                    TranslationsService.labels(`solutions.items`).map((_sub, i) => (
                                         !_sub.comingSoon &&
                                            <li key={i} className="mb-3">
                                                <Link to={`/${lang}/solutions/${_sub.id}`} className="text-uppercase fs-5" onClick={() => {mouseEventSolutions(false); closeMobileMenu()}}>
                                                    <h2 style={{color: '#fece2f', fontWeight: 600}}>{_sub.title}</h2>
                                                    <p style={{textTransform: 'capitalize'}}>{_sub.subtitle}</p>
                                                </Link>
                                            </li>
                    ...
                    {
                        TranslationsService.sectionAvailable('products') &&
                        <div className={`container sub-nav-mob ${showProducts ? 'show-products-menu':''}`}>
                            ...
                            <ul>
                                {
                                    Object.keys(TranslationsService.labels(`products`)).map((_sub, i) => (
                                        <li key={i} className="mb-3">
                                            <Link to={`/${lang}/products/${_sub}`} className="text-uppercase fs-5" onClick={() => {mouseEventProducts(false); closeMobileMenu()}}>{TranslationsService.labels(`products.${_sub}.title`)}</Link>
                                        </li>
                                    ))
                                }
                            </ul>
                    ...
                    {
                        TranslationsService.sectionAvailable('industries') &&
                        <div className={`container sub-nav-mob ${showIndustries ? 'show-industries-menu':''}`}>
                            ...
                            <ul>
                                {
                                    Object.keys(TranslationsService.labels(`industries`)).map((_sub, i) => (
                                        <li key={i} className="mb-3">
                                            <Link to={`/${lang}/industries/${_sub}`} className="fs-5" onClick={() => {mouseEventIndustries(false); closeMobileMenu()}}>{TranslationsService.labels(`industries.${_sub}.title`)}</Link>
                                        </li>
                                    ))
                                }
                            </ul>
                    ...
                    {
                        TranslationsService.sectionAvailable('insights') &&
                        <div className={`container sub-nav-mob ${showInsights ? 'show-insights-menu':''}`}>
                                ...
                                <ul>
                                    {
                                        ...
                                        <li className="mb-3 row-submenu-mobile">
                                            <Link to={`/${lang}/insights/blog`} className="text-capitalize fs-6 link-mobile-menu" onClick={() => {mouseEventInsights(false); closeMobileMenu()}}>Blog <ArrowForwardIosIcon sx={{ fontSize: '16px' }} /></Link>
                                        </li>
                                    }
                                    {
                                        TranslationsService.childMenuAvailable('insightsSections.client-stories') && 
                                        <li className="mb-3 row-submenu-mobile">
                                            <Link to={`/${lang}/insights/client-stories`} className="text-capitalize fs-6 link-mobile-menu" onClick={() => {mouseEventInsights(false); closeMobileMenu()}}>{TranslationsService.labels('client_stories')} <ArrowForwardIosIcon sx={{ fontSize: '16px' }} /></Link>
                                        </li>
                                    }
                                    <li className="mb-3 row-submenu-mobile">
                                        <NavLink to={`/${lang}/insights/events`} className="text-capitalize fs-6 link-mobile-menu" onClick={() => {mouseEventInsights(false); closeMobileMenu()}}>{TranslationsService.labels('events')} <ArrowForwardIosIcon sx={{ fontSize: '16px' }} /></NavLink>
                                    </li>
                                    {/* {
                                        Object.keys(TranslationsService.labels(`products`)).map((_sub, i) => (
                                            <li key={i} className="mb-3">
                                                <Link to={`products/${_sub}`} className="text-uppercase fs-5" onClick={() => {mouseEventProducts(false); closeMobileMenu()}}>{TranslationsService.labels(`products.${_sub}.title`)}</Link>
                                            </li>
                                        ))
                                    } */}
                                </ul>
                    ...
                    {
                        TranslationsService.sectionAvailable('about') &&
                        <div className={`container sub-nav-mob ${showAbout ? 'show-about-menu':''}`}>
                            ...
                            <ul>
                                <li className="mb-3 row-submenu-mobile">
                                    <Link to={`/${lang}/about`} className="text-capitalize fs-6 link-mobile-menu" onClick={() => {mouseEventAbout(false); closeMobileMenu()}}>{TranslationsService.labels('our_history')} <ArrowForwardIosIcon sx={{ fontSize: '16px' }} /></Link>
                                </li>
                                {
                                    TranslationsService.childMenuAvailable('aboutSections.r&d') && 
                                    <li className="my-3 row-submenu-mobile">
                                        <Link to={`/${lang}/about/rnd`} className="text-capitalize fs-6 link-mobile-menu" onClick={() => {mouseEventAbout(false); closeMobileMenu()}}>R&D <ArrowForwardIosIcon sx={{ fontSize: '16px' }} /></Link>
                                    </li>
                                }
                                {
                                    TranslationsService.childMenuAvailable('aboutSections.certifications') && 
                                    <li className="my-3 row-submenu-mobile">
                                        <Link to={`/${lang}/about/our-certifications`} className="text-capitalize fs-6 link-mobile-menu" onClick={() => {mouseEventAbout(false); closeMobileMenu()}}>{TranslationsService.labels('our_certifications')} <ArrowForwardIosIcon sx={{ fontSize: '16px' }} /></Link>
                                    </li>
                                }
                                {
                                    TranslationsService.childMenuAvailable('aboutSections.partners') && 
                                    <li className="my-3 row-submenu-mobile">
                                        <Link to={`/${lang}/about/our-partners`} className="text-capitalize fs-6 link-mobile-menu" onClick={() => {mouseEventAbout(false); closeMobileMenu()}}>{TranslationsService.labels('our_partners')} <ArrowForwardIosIcon sx={{ fontSize: '16px' }} /></Link>
                                    </li>
                                }
                                {/* <li className="my-3">
                                    <Link to={`/${lang}/about/the-real-submarine`} className="text-uppercase fs-5" onClick={() => {mouseEventAbout(false); closeMobileMenu()}}>The Real Submarine</Link>
                                </li> */}
                            </ul>
                        </div>
                    }

                    <div className={`container sub-nav-mob ${showLanguageMob ? 'show-language-menu':''} transition-03s-eio`}>
                        <div className="d-flex p-3 navbar-sub-nav" onClick={() => {setShowMobileMenu(true); setShowLanguageMob(false)}}>
                            <svg id="Livello_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 11.43 20" width="10" fill="#fcfcfc"><path d="m10,20c-.37,0-.73-.14-1.01-.42L.42,11.01c-.27-.27-.42-.63-.42-1.01s.15-.74.42-1.01L8.99.42c.56-.56,1.46-.56,2.02,0s.56,1.46,0,2.02l-7.56,7.56,7.56,7.56c.56.56.56,1.46,0,2.02-.28.28-.64.42-1.01.42Z"/></svg>
                            <p className="m-0 fw-bold ms-2 fs-3">{TranslationsService.labels('language')}</p>
                        </div>
                        <ul className="sub-nav-list">
                            <li onClick={() => handleLanguageSelect('en')} className="mb-3 row-submenu-mobile">
                            ...
                            <li onClick={() => handleLanguageSelect('it')} className="mb-3 row-submenu-mobile">
                                <span className="dropdown-item d-flex gap-2 align-items-center transition-03s-eio">
                    ...
                    <div className={`container sub-nav-mob ${showLocationsMob ? 'show-language-menu':''} transition-03s-eio`}>
                        <div className="d-flex p-3" onClick={() => {setShowMobileMenu(true); setShowLocationsMob(false)}}>
                            <svg id="Livello_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 11.43 20" width="10" fill="#fcfcfc"><path d="m10,20c-.37,0-.73-.14-1.01-.42L.42,11.01c-.27-.27-.42-.63-.42-1.01s.15-.74.42-1.01L8.99.42c.56-.56,1.46-.56,2.02,0s.56,1.46,0,2.02l-7.56,7.56,7.56,7.56c.56.56.56,1.46,0,2.02-.28.28-.64.42-1.01.42Z"/></svg>
                            <p className="m-0 fw-bold ms-2 fs-3">{TranslationsService.labels('locations')}</p>
                        </div>
                        <ul>
                        {
                        TranslationsService.getOffice()?.map((office, ind) => (
                            <li key={ind} className="mb-3 row-submenu-mobile">
                                <a href={office.mapsLink || undefined} target="_blank" rel="noreferrer">
                                    <p className="m-0 d-flex align-items-center" style={{gap:'0.3rem'}}><ApartmentOutlinedIcon sx={{color:'#fece2f', fontSize: '18px'}}/><span className="dark-mode-title fw-bold">{office.name}</span></p>
