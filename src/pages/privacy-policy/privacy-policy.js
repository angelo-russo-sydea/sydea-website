...
export const PrivacyPolicy = () => {
  ...
  document.title = `Privacy Policy | ${TranslationsService.getMainInfoCompany('name')}`;
      ...
      <div className="container">
        ...
        <div className="py-3">
          <h2 className="fs-3 fw-bold">
            Privacy Policy Sydea S.r.l.
          </h2>

          <div className="fs-5" id="en">
            <p className="fs-6">Last updated: August 4, 2023</p>
            <p>
            ...
            <h1 className="fw-bold pt-3">Interpretation and Definitions</h1>
            <h2 className="fw-bold">Interpretation</h2>
            <p>
            ...
            <ul>
              ...
              <li>
                <p>
                  ...
                  "We", "Us" or "Our" in this Agreement) refers to Sydea S.r.l.,
                  Via Edith Stein, 7 – 40013 Castel Maggiore (BO).
                </p>
              </li>
              <li>
                <p>
              ...
              <li>
                <p>
                  <strong>Website</strong> refers to Sydea, accessible from{" "}
                  <a
                    href="https://www.sydea.it"
            ...
            <h1 className="fw-bold pt-3">Collecting and Using Your Personal Data</h1>
            ...
            <h3 className="fw-bold">Tracking Technologies and Cookies</h3>
            <p>
            ...
            <h2 className="fw-bold pt-3">Use of Your Personal Data</h2>
            ...
            <h2 className="fw-bold pt-3">Retention of Your Personal Data</h2>
            <p>
            ...
            <h2 className="fw-bold pt-3">Transfer of Your Personal Data</h2>
            <p>
            ...
            <h2 className="fw-bold pt-3">Delete Your Personal Data</h2>
            <p>
            ...
            <h2 className="fw-bold pt-3">Disclosure of Your Personal Data</h2>
            <h3 className="fw-bold">Business Transactions</h3>
            <p>
            ...
            <h3 className="fw-bold">Law enforcement</h3>
            <p>
            ...
            <h3 className="fw-bold">Other legal requirements</h3>
            <p>
            ...
            <h1 className="fw-bold pt-3">Children's Privacy</h1>
            <p>
            ...
            <h1 className="fw-bold pt-3">Links to Other Websites</h1>
            <p>
            ...
            <h1 className="fw-bold pt-3">Changes to this Privacy Policy</h1>
            <p>
            ...
            <h1 className="fw-bold pt-3">Contact Us</h1>
            <p>
              If you have any questions about this Privacy Policy, You can
              contact us:
            </p>
            <ul>
              <li>By email: info@sydea.it</li>
            </ul>
          </div>
        </div>
      </div>
