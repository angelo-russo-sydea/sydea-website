...
export const SydeaKnowledgeBase = () => {
  ...
  const getIconCategory = (category) => {
    switch (category) {
      ...
      case 'Operation/Projects': case 'Operazioni/Progetti': return <LightbulbIcon color={selectedCategory === category ? "inherit" : "action"}/>;
                        ...
                        selectedCategory && selectedSubcategory ? (
                          <>
                            <Box sx={{ display: 'flex', gap: 1, alignItems: 'center', flexWrap: 'wrap' }}>
                              <p className="m-0 breadcrumb-text custom-icon-size" onClick={onclickHomeIcon}>
                                <HomeIcon />
                              </p>
                              <p className="m-0 breadcrumb-text custom-icon-size" onClick={() => setSelectedSubcategory(null)}>/</p>
                              ...
                              <p className="m-0 breadcrumb-text custom-icon-size">{selectedSubcategory}</p>
                            </Box>
                            <List>
                              {selectedSubcategory && (
                          ...
                          {popularDocs.map((item) => (
                            <li key={item.id}>
                              <a
                                ...
                                onClick={(e) => {
                                  e.preventDefault();
                                  navigate(`/${lang}/sydea-hub/sydea-knowledge-base?itemid=${item.id}`, { replace: true });
                                }}
                              >
                                {item.question}
                              </a>
